...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'shareware'">Desi adda</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="products.php" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#handi" class="dropdown-item">Handicrafts</a>
                                   <a href="products.php#hd" class="dropdown-item">Home decor</a>
                                   <a href="products.php#fandb" class="dropdown-item">Food and Beverages</a>
                               </div>
